...
label(3 "MI 20") label(4 "Mi 100") pos(6) cols(2)) xtitle(Poverty rate) ytitle("Bias x 100")
...
legend(label(1 "Empirical Bias - OLS") label(2 "Empirical Bias - nested")  ///
label(3 "MI 20") label(4 "Mi 100") pos(6) cols(2)) xtitle(Poverty rate) ytitle("MSE x 10000")
